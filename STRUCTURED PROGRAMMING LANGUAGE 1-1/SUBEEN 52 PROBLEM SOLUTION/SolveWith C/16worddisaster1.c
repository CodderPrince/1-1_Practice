    ...
    while(t--)
    {
        ...
        for(i=0; i<strlen(str); i++)
        {
            if(str[i]!=' ')
            {
             ...
             string er moddhe store korbe*/
                ...
                ekta word shes howar porei jokhon space pabe tokhon ei
                loop er moddhe dhukbe*/
            {
                re[j]='\0';
        ...
        if(j>0)
         /*jokhon only single ekta word thakbe tokhon ei loop
          ...
          uporer for loop cholbe string er length porjonto
          tai jokhoni last word asbe tokhe ar else if or else
          kaj korbe na tokhon new if condition check korbe
          raajkumae! eta count howar por ar else if or else
          kaj korbe na tokhon nicher if condition kaj korbe*/
        {
            re[j]='\0';
            reverse(re);
        }
